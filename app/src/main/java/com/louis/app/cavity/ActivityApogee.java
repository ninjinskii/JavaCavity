...
public class ActivityApogee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apogee);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);

        mCoordinatorLayout = findViewById(R.id.APOGEE_coordinator);
        tvEmpty = findViewById(R.id.APOGEE_empty);

        mAdapteurBou = new AdapteurBou(this);

        mRecyclerView = findViewById(R.id.APOGEE_recyclerView);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setAdapter(mAdapteurBou);

        mVinViewModel = ViewModelProviders.of(this).get(VinViewModel.class);
        mVinViewModel.getBouteillesToDrink(ANNEE).observe(this, new Observer<List<Bouteille>>() {
            @Override
        ...
        mAdapteurBou.setOnItemLongClickListener(new AdapteurBou.OnItemLongClickListener() {
            ...
            public void onItemLongClick(Bouteille bou) {
                ...
                Intent intent = new Intent(ActivityApogee.this, ActivityAjoutBouteille.class);
        ...
        mAdapteurBou.setOnItemClickListener(new AdapteurBou.OnItemClickListener() {
            ...
            public void onItemClick(Bouteille bou) {
                Intent intent = new Intent(ActivityApogee.this, ActivityVueBouteille.class);
